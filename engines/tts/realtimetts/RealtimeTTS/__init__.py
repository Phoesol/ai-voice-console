...
def _load_mimo_engine():
    from .engines.mimo_engine import MimoEngine, MimoVoice
    globals()["MimoEngine"] = MimoEngine
    globals()["MimoVoice"] = MimoVoice
    return MimoEngine
...
_lazy_imports = {
    ...
    "MimoEngine": _load_mimo_engine,
    "MimoVoice": _load_mimo_engine,
}
